...
theme.menuAdjust = function() {
    ...
    ;
    var i = document.querySelector(".toggleMenu")
      , n = document.querySelector(".responsiveMenu")
      , r = document.getElementById("cart-dropdown")
      , a = document.getElementById("cart-count-mobile")
      , s = document.getElementById("cart-count-desktop")
      , l = n.querySelectorAll("li");
    if (e <= t || function() {
        var e = document.querySelector(".header-navigation .relative").offsetWidth - document.querySelector(".logo a").offsetWidth;
        const t = document.querySelectorAll(".parent-level");
        let o = 20;
        return t.forEach(e=>{
            o += e.offsetWidth
        }
        ...
        i.classList.remove("isDesktop"),
        i.classList.add("isMobile"),
        i.classList.contains("active") ? n.style.display = "block" : n.style.display = "none",
        n.classList.remove("isDesktop"),
        n.classList.add("isMobile"),
        n.querySelectorAll(".parent-level-ul").forEach(function(e) {
        ...
        n.querySelectorAll("li.has-dropdown a.parent").forEach(function(e) {
        ...
        i.classList.remove("isMobile"),
        i.classList.add("isDesktop"),
        ...
        n.querySelectorAll("li.parent").forEach(function(e) {
            e.onmouseenter = function(t) {
                n.querySelectorAll("li.hover").forEach(function(e) {
...
theme.Header = function() {
    return function(e) {
        ...
        if (theme.css = document.head.querySelector('link[href*="/styles.min.css"]'),
        ...
        "/challenge" == location.pathname)
            ...
            var d = document.querySelector(".feedback");
            if (!d)
                return;
            var u = d.getBoundingClientRect().top + window.pageYOffset;
            window.scrollTo({
                top: u - document.selectors.sht,
                behavior: "smooth"
            })
        }
...
var CartVar=u;
          CartVar.total_price = wcpcartdata.wcp_cart_total;
              CartVar.items_subtotal_price = wcpcartdata.wcp_cart_total;
    ...
    t = CartVar;
        ...
        t.items.length > 0) {
            ...
            for (var s = 0; s < a; s++) {
                ...
                _.appendChild(L),
                S.appendChild(_),
                t.items[s].selling_plan_allocation && (A.classList.add("bottompad-quarter"),
                q.textContent = t.items[s].selling_plan_allocation.selling_plan.name,
                A.appendChild(q),
                L.appendChild(A),
                _.appendChild(L),
                S.appendChild(_)),
                x.classList.add("product-price"),
                f > 0)
                ...
                _.appendChild(x),
                S.appendChild(_),
                I.classList.add("vendors"),
                I.innerHTML = y > 0 ? theme.language.cart_general_carttotal + " " + Shopify.formatMoney(v, theme.moneyFormat) + " | <s>" + Shopify.formatMoney(g, theme.moneyFormat) + "</s>" : theme.language.cart_general_carttotal + " " + Shopify.formatMoney(v, theme.moneyFormat),
                T.appendChild(I),
                _.appendChild(T),
                S.appendChild(_),
                b.appendChild(S),
    ...
    e.querySelectorAll('[type="submit"]').forEach(function(o) {
        o.onclick = function(i) {
            ...
            if (n.elements.quantity)
                var h = n.elements.quantity.value;
            else
                h = 1;
            let m = {
                items: [{
                        ...
                        if (t) {
                            ...
                            t.results.forEach(function(e, t) {
                                ...
                                if (null != e.vendor) {
                                    ...
                                    t.appendChild(o),
                                    //o.innerText = e.vendor,       <-- Remove vendor name from SEARCH -->
                                    a = t
                                }
...
theme.product_options_js = function(e) {
    ...
    c.uniq = function(e) {
        for (var t = [], o = 0; o < e.length; o++)
            c.arrayIncludes(t, e[o]) || t.push(e[o]);
        return t
    }
    ,
    c.optionsMap = {};
    ...
    if (c.updateOptionsInSelector = function(e) {
        ...
        case 1:
            ...
            n = document.querySelector(i.sos1);
            break;
        case 2:
            o = document.querySelector(i.sos0).value;
        ...
        document.querySelectorAll("#product-id-" + t + ' form[action="/cart/add"] .swatch[data-option-index="' + e + '"] .swatch-element').forEach(function(e) {
            ...
            t.checked = !1,
            -1 !== a.indexOf(e.getAttribute("data-value"), a) ? (e.style.display = "",
            t.disabled = !1) : (e.style.display = "none",
            t.disabled = !0)
        }),
        -1 !== a.indexOf(r, a) && (n.value = r),
    ...
    c.linkOptionSelectors = function(e) {
        for (var t = 0; t < e.variants.length; t++) {
            var o = e.variants[t];
            if (o) {
                if (c.optionsMap.root = c.optionsMap.root || [],
                c.optionsMap.root.push(o.option1),
                c.optionsMap.root = c.uniq(c.optionsMap.root),
                e.options.length > 1) {
                    var n = o.option1;
                    c.optionsMap[n] = c.optionsMap[n] || [],
                    c.optionsMap[n].push(o.option2),
                    c.optionsMap[n] = c.uniq(c.optionsMap[n])
                }
                if (3 === e.options.length) {
                    n = o.option1 + " / " + o.option2;
                    c.optionsMap[n] = c.optionsMap[n] || [],
                    c.optionsMap[n].push(o.option3),
                    c.optionsMap[n] = c.uniq(c.optionsMap[n])
                }
            }
        }
        c.updateOptionsInSelector(0),
        e.options.length > 1 && c.updateOptionsInSelector(1),
        3 === e.options.length && c.updateOptionsInSelector(2),
        document.querySelector(i.sos0).addEventListener("change", function() {
            return c.updateOptionsInSelector(1),
            3 === e.options.length && c.updateOptionsInSelector(2),
            !0
        }),
        document.querySelector(i.sos1).addEventListener("change", function() {
            return 3 === e.options.length && c.updateOptionsInSelector(2),
            !0
        })
    }
    ,
    n.available && n.options.length > 1) {
        var d = document.querySelector("#product-id-" + t + " form[data-product-form]");
        if (window.MutationObserver && d.length) {
            ...
            var u = new MutationObserver(function() {
                c.linkOptionSelectors(JSON.parse(document.getElementById("ProductJson-" + t).innerHTML)),
                u.disconnect()
            }
            );
            u.observe(d, {
    ...
    if (n.variants.length > 1) {
        var h, m, p, f, y, g, v = {}, b = n.variants, S = n.options;
        if (b.forEach(function(e) {
            void 0 !== (h = e).featured_image && null !== h.featured_image && (m = h.featured_image.src.split("?")[0].replace(/http(s)?:/, ""),
            v[m] = v[m] || {},
            e.options.forEach(function(e, t) {
                ...
                void 0 === v[m][p])
                    ...
                    var o = v[m][p];
                    null !== o && o !== f && (v[m][p] = null)
                }
            }))
        }),
        !(g = document.querySelectorAll("#product-id-" + t + " .thumbs a")))
            return !1;
        g.forEach(function(e) {
            e.addEventListener("click", function(e) {
                var o = this.querySelector("img[data-source].list").getAttribute("data-source").split("?")[0].replace(/(_1x)/, "");
                void 0 !== v[o] && S.forEach(function(e, i) {
    ...
    setTimeout(function() {
        document.getElementById("product-id-" + t).querySelectorAll(".selector-wrapper").forEach(function(e, o) {
            var i, n = document.getElementById(r).getAttribute("data-cols"), a = e.querySelector("select"), s = document.getElementById(r).getAttribute("data-size"), l = document.getElementById(r).getAttribute("data-color"), c = e.querySelector("label").textContent;
            a.options.length > document.getElementById("product-select-" + t).getAttribute("data-length") && (s.length && c.indexOf(s) > -1 || l.length && c.indexOf(l) > -1 ? (e.classList.add("selectors"),
            e.setAttribute("data-option-index", o),
            (i = document.createElement("div")).className = "hidden",
            e.parentNode.insertBefore(i, e),
            i.appendChild(e)) : (e.classList.add("selectors"),
            e.style.display = "block",
            e.setAttribute("data-option-index", o),
    ...
    if (_) {
        var L = document.getElementById("glider-button-next-thumbs-" + t)
          , w = document.getElementById("glider-button-prev-thumbs-" + t);
        new Glider(_,{
            arrows: {
                prev: w,
                next: L
    ...
    if ("false" == l && 1 == theme.mobile ? theme.mobilezoom = !1 : theme.mobilezoom = !0,
    "true" == s && 1 == theme.mobilezoom) {
    ...
    new Shopify.OptionSelectors(n,{
        ...
        var WCP_JSON=[];
            ...
            if (document.getElementsByClassName('wcp_vd_table').length != 0 && document.getElementById('vdtable') != null) {
              var wpd_source = document.getElementById('vdtable').innerHTML;
              var wpd_template = Handlebars.compile(wpd_source);
              if (document.getElementsByClassName('wcp_vd_table')[0] != undefined && document.getElementsByClassName('wcp_vd_table')[0].innerText != '') {
                var wpd_context = JSON.parse(document.getElementsByClassName('wcp_vd_table')[0].innerText);
                var vdtable = [];
                vdtable['vdtable'] = wpd_context['wpd_' + o.id];
                if(vdtable['vdtable']){
                vdtable['vdtable'].forEach(function (arrayItem) {
                  arrayItem.Price = arrayItem.Price.replace(/<\/?span[^>]*>/g, '');
                });
                }
                var wpd_html = wpd_template(vdtable);
				try{
					document.getElementById('wcp_vd_table').innerHTML = wpd_html;
				}catch(e){
            ...
            o) {
                ...
                for (var A = 0, q = o.options.length; A < q; A++) {
                    ...
                    if (x) {
                        var C = o.options[A].replace(/["\\]/g, "\\$&")
                          , T = x.querySelector('.swatch-element[data-value="' + C + '"]');
                        x.querySelector('input[value="' + C + '"]') && (x.parentElement.classList.remove("hidden"),
                        T.classList.add("active")),
...
theme.Product = function() {
    ...
    Shopify.OptionSelectors.prototype.buildSelectors = function() {
        ...
        return Shopify.map(this.selectors, function(e) {
            var t = document.createElement("div");
            if (t.setAttribute("class", o),
            i.length >= 1) {
                var n = document.createElement("label");
                n.htmlFor = e.element.id,
                n.innerHTML = e.name,
                t.appendChild(n)
            }
    ...
    return function(e) {
        ...
        o.r = function(e) {
            t(),
            t(),
            "undefined" != typeof Symbol && Symbol.toStringTag && (t(),
    ...
    function e(t) {
        ...
        document.getElementById("glider-carousel-" + o))
